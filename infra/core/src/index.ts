...
const project = config.get('project') || 'gcp-playground-365316';
...
const example = new gcp.iam.WorkloadIdentityPoolProvider("example-pool-provider-pulumi", {
